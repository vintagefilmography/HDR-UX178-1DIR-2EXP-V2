...
Public Class Form1
    ...
    Dim ExpTest1 As Double = 0
    Dim ExpTest2 As Integer = 0
    Dim ExpTest3 As String = ""
...
err_Form_Load:
    ...
    Private Sub ExpDisplay_click(sender As Object, e As EventArgs) Handles ExpDisplay.Click
        ...
        If ExpValue > 0.004 Then
            MessageBox.Show("Exposure=" + ExpString.Substring(0, 6))
        Else
            ExpTest1 = 1 / ExpValue
            ExpTest2 = Math.Abs(ExpTest1)
            ExpTest3 = Str(ExpTest2)

            MessageBox.Show("Exposure=" + "1/" + ExpTest3)
        End If
